...
//			break;
		...
		case 'H':	// serial.html
			...
			get_serial(7);
			break;
		case 'a':	// ser_con_mon.html
			strcpy(target_page, "ser_con_mon.html");
			get_ser_con_mon(0);
			break;
		case 'b':	// ser_con_mon.html
			strcpy(target_page, "ser_con_mon.html");
			get_ser_con_mon(1);
			break;
		case 'c':	// ser_con_mon.html
			strcpy(target_page, "ser_con_mon.html");
			get_ser_con_mon(2);
			break;
		case 'd':	// ser_con_mon.html
			strcpy(target_page, "ser_con_mon.html");
			get_ser_con_mon(3);
			break;
		case 'e':	// ser_con_mon.html
			strcpy(target_page, "ser_con_mon.html");
			get_ser_con_mon(4);
			break;
		case 'f':	// ser_con_mon.html
			strcpy(target_page, "ser_con_mon.html");
			get_ser_con_mon(5);
			break;
		case 'g':	// ser_con_mon.html
			strcpy(target_page, "ser_con_mon.html");
			get_ser_con_mon(6);
			break;
		case 'h':	// ser_con_mon.html
			strcpy(target_page, "ser_con_mon.html");
			get_ser_con_mon(7);
			break;
