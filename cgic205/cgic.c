...
#ifdef CGICDEBUG
			CGICDEBUGSTART
			fprintf(dout, "multipart input %d\n",cgiContentLength);
			CGICDEBUGEND	
#endif /* CGICDEBUG */
...
#ifdef CGICDEBUG
			CGICDEBUGSTART
			fprintf(dout, "result:%d afterNextBoundary\n",result);
			CGICDEBUGEND	
#endif /* CGICDEBUG */
...
cgiFormResultType cgiFormtFileName(
	char *name, char *result, int resultSpace)
{
	cgiFormEntry *e;
	int resultLen = 0;
